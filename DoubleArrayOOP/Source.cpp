...
int main()
{
	...
	cout << "”даление повтор€ющихс€ элементов массива: "; ar1.delElem();
    ar1.print();
	cout << "—ортировка нашего массива: "; ar1.Sort();
	ar1.print();
	cout << "¬ведите количество элементов массива: "; ar1.enterCount();
    ar1.print();
	cout << "—умма всех элементов массива:";
    cout << ar1.Sum();
	cout << endl;
	ar1.print();
	return 0;
